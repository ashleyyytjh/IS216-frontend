...
| Note Creation | Upload Notes - Processing | At the last step, the screen will display processing, where backend and database insertion is occurring. Once done, the user will be directed to a success page. |
