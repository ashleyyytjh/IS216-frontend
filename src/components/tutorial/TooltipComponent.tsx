    ...
    >
      ...
      <CardContent className="text-sm text-muted-foreground flex flex-row justify-between p-0 ">
        <Button
          ...
          disabled={index === 0}
          className={cn(
            "h-8 w-8 bg-transparent hover:bg-transparent text-muted-foreground hover:text-foreground",
        ...
        {continuous && (
          <Button
            size="icon"
            {...primaryProps}
            className="h-8 w-8 bg-transparent hover:bg-transparent text-muted-foreground hover:text-foreground"
            variant="ghost"
          >
