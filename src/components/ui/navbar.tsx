...
const Navbar = () => {
  return (
      ...
      max-w-full sticky top-0 z-50 h-16
      ">
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div className="hidden sm:ml-6 sm:block">
                  <div className="flex space-x-4">
                    <a href="#" aria-current="page" className="px`x-3 py-2 text-sm font-medium text-[#00AFF0]">Home</a>
                    <a href="#" className="rounded-md px-3 py-2 text-sm font-medium text-[#00AFF0] hover:bg-white/5 hover:text-white">Notes Repository</a>
                    <a href="#" className="rounded-md px-3 py-2 text-sm font-medium text-[#00AFF0] hover:bg-white/5 hover:text-white">Upload Notes</a>
                  </div>
                </div>
              </div>
          ...
          <el-disclosure id="mobile-menu" hidden class="block sm:hidden">
            <div className="space-y-1 px-2 pt-2 pb-3">
              ...
              <a href="#" className="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-white/5 hover:text-white">Notes Repository</a>
              <a href="#" className="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-white/5 hover:text-white">Upload Notes</a>
            </div>
          </el-disclosure>
        </nav>
  );
