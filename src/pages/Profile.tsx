...
const Profile = () => {
  ...
  if (!currentUser) return  <div className="flex justify-center item-center text-center mt-100 mb-100 container"><h1 className="text-3xl text-gray-600">No User Data found</h1></div>
